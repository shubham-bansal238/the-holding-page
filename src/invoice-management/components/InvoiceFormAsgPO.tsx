...
import { InvoiceData } from "@/invoice-management/utils/firebaseAsgPO";
  ...
  const handleSubmit = async (e: React.FormEvent, action: 'save' | 'saveAsNew' | 'generatePdf' = 'save') => {
    ...
    try {
      const invoiceData: InvoiceData = {
        ...
        invoiceNumber: formData.invoiceNumber.startsWith("ASG/PO/2026-27/")
          ? formData.invoiceNumber
          : `ASG/PO/2026-27/${formData.invoiceNumber}`,
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <Input
                ...
                placeholder="ASG/PO/2026-27/001"
                required
              />
            </div>
            <div>
