...
import { InvoiceData } from "@/invoice-management/utils/firebaseDecoustPO";
...
const InvoiceForm = ({
  ...
  const [formData, setFormData] = useState<InvoiceData>({
    ...
    seller: {
      ...
      address:
        "KHASRA No- 447, Gulistanpur, Surajpur Site-C, Greater Noida, G.B Nagar - 201310, State: Uttar Pradesh, Code:09, PAN No.: AAJCD3488R",
  ...
  const handleSubmit = async (e: React.FormEvent, action: 'save' | 'saveAsNew' | 'generatePdf' = 'save') => {
    ...
    try {
      const invoiceData: InvoiceData = {
        ...
        invoiceNumber: formData.invoiceNumber.startsWith("DTS/PO/2026-27/")
          ? formData.invoiceNumber
          : `DTS/PO/2026-27/${formData.invoiceNumber}`,
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <Input
                ...
                placeholder="DTS/PO/2026-27/001"
                required
              />
            </div>
            <div>
