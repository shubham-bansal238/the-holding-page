...
import { InvoiceData } from "@/invoice-management/utils/firebaseAsg";
...
const InvoiceForm = ({
  ...
  const [formData, setFormData] = useState<InvoiceData>({
    ...
    gstRate: 18,
    seller: {
      name: "ASG THERMOACOUSTIC SOLUTIONS",
      address:
        "131 C, Block No 33, Sector 73, Noida, District - Gautum Buddha Nagar, 201307",
      gstin: "09ACGFA9555J1ZV",
      email: "sales@asgthermotech.com",
    },
    consignee: {
      name: "",
      address: "",
...
4. Payments should be made through NEFT/RTGS/IMPS in favour of company in Punjab National Bank, Current Account No 1236102100001209, IFS Code PUNB0123610.
...
Current Account No 1236102100001209,
  ...
  const handleSubmit = async (e: React.FormEvent, action: 'save' | 'saveAsNew' | 'generatePdf' = 'save') => {
    ...
    try {
      const invoiceData: InvoiceData = {
        ...
        invoiceNumber: formData.invoiceNumber.startsWith("ASG/2026-27/")
          ? formData.invoiceNumber
          : `ASG/2026-27/${formData.invoiceNumber}`,
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData((prev) => ({ ...prev, rrLrNo: e.target.value }))
                }
              />
            </div>
            <div>
              ...
              <Input
                type="date"
                value={formData.rrLrDate}
                onChange={(e) =>
                  setFormData((prev) => ({ ...prev, rrLrDate: e.target.value }))
                }
              />
            </div>
            <div>
            ...
            <div>
              ...
              <Input
                value={formData.consignee.modeOfTransport}
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    consignee: {
            ...
            <div>
              ...
              <Input
                value={formData.consignee.destination}
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    consignee: {
            ...
            <div>
              ...
              <Input
                value={formData.consignee.vehicleNo}
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    consignee: {
            ...
            <div>
              ...
              <Input
                value={formData.documentsThru}
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    documentsThru: e.target.value,
                  }))
                }
              />
            </div>
            ...
            <div>
              <label className="block text-sm font-medium mb-1">LC No.</label>
              <Input
                value={formData.lcNo}
                onChange={(e) =>
                  setFormData((prev) => ({
