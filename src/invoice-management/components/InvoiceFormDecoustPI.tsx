...
import { InvoiceData } from "@/invoice-management/utils/firebaseDecoustPi";
...
const InvoiceForm = ({
  ...
  const [formData, setFormData] = useState<InvoiceData>({
    ...
    challanDate: "",
    lcNo: "",
    termsOfDelivery: "Decoust Tech factory gate",
    insuranceText: "",
    paymentDueDate: "",
    documentsThru: "",
    freightText: "",
...
4. Payments should be made through NEFT/RTGS/IMPS in favour of company in Punjab National Bank, Current Account No 1236105500000047, IFS Code PUNB0123610.
...
Current Account No 1236105500000047,
  ...
  const handleSubmit = async (e: React.FormEvent, action: 'save' | 'saveAsNew' | 'generatePdf' = 'save') => {
    ...
    try {
      const invoiceData: InvoiceData = {
        ...
        invoiceNumber: formData.invoiceNumber.startsWith("DTS/2026-27/")
          ? formData.invoiceNumber
          : `DTS/2026-27/${formData.invoiceNumber}`,
