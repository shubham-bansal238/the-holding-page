...
import { InvoiceData } from "@/invoice-management/utils/firebaseMohitPO";
  ...
  const handleSubmit = async (e: React.FormEvent, action: 'save' | 'saveAsNew' | 'generatePdf' = 'save') => {
    ...
    try {
      const invoiceData: InvoiceData = {
        ...
        invoiceNumber: formData.invoiceNumber.startsWith("MI/PO/2026-27/")
          ? formData.invoiceNumber
          : `MI/PO/2026-27/${formData.invoiceNumber}`,
